...
export const lazyRouteComponents: Record<NavSection, LazyRouteComponent> = {
  ...
  knowledge: lazy(() => import("../../features/knowledge-hub/KnowledgeHubSection")),
  documents: lazy(() => import("../../features/knowledge-hub/KnowledgeHubSection")),
  meetings: lazy(() => import("../../features/meetings/MeetingsSection")),
  alerts: lazy(() => import("../../features/alerts/AlertsSection")),
