...
export const appRoutes: AppRoute[] = [
  ...
  { id: "ai-review-inbox", section: "ai-workspace", path: "ai-workspace/review-inbox", label: "AI Review Inbox", module: "ai-review-inbox", description: "Tenant-facing review queue for cited AI outputs before consequential action", access: "organization-protected", requiresAuth: true },
  ...
  { id: "workflow-records", section: "tasks", path: "workflow-records", label: "Workflow Records", module: "workflow-records", description: "Approval requests, stakeholder notes, and project updates created from governed AI decisions", access: "organization-protected", requiresAuth: true },
  { id: "approvals", section: "approvals", path: "approvals", label: "Approvals & Governance", module: "approvals", description: "Human-in-the-loop review and approval queue for high-trust institutional actions", access: "organization-protected", requiresAuth: true },
  ...
  { id: "integrations", section: "integrations", path: "integrations", label: "Integrations", module: "integrations", description: "Selected-message email import, OAuth connector setup, and plugin health", access: "organization-protected", requiresAuth: true },
  ...
  { id: "pilot-command-center", section: "organization-admin", path: "admin/pilot-command-center", label: "Pilot Command Center", module: "pilot-command-center", description: "Unified pilot operations command center for connectors, AI review, sandbox policy, RAG evaluation, and audit evidence", access: "role-protected", requiresAuth: true, requiredRoles: ["Super Admin", "Organization Admin"] },
  ...
  { id: "plugin-runtime", section: "integrations", path: "admin/plugin-runtime", label: "Plugin Runtime", module: "plugin-runtime", description: "Tenant-owned connector runtime, scopes, sync, webhook, and revocation controls", access: "role-protected", requiresAuth: true, requiredRoles: ["Super Admin", "Organization Admin"] },
  { id: "model-policy", section: "ai-workspace", path: "admin/model-policy", label: "Model Policy", module: "model-policy", description: "Provider-neutral model routing, fallback, budget, and human-review controls", access: "role-protected", requiresAuth: true, requiredRoles: ["Super Admin", "Organization Admin"] },
  { id: "execution-runs", section: "organization-admin", path: "admin/execution-runs", label: "Execution Runs", module: "execution-runs", description: "Sandbox, Kubernetes-ready, and dry-run workflow execution controls", access: "role-protected", requiresAuth: true, requiredRoles: ["Super Admin", "Organization Admin"] },
  { id: "usage-limits", section: "organization-admin", path: "admin/usage-limits", label: "Usage Limits", module: "usage-limits", description: "Tenant usage limits for AI, RAG, plugins, sandbox runs, and audit exports", access: "role-protected", requiresAuth: true, requiredRoles: ["Super Admin", "Organization Admin"] },
  { id: "support-ops", section: "organization-admin", path: "admin/support-ops", label: "Support Operations", module: "support-ops", description: "Incident, readiness, and operations review surface for live pilots", access: "role-protected", requiresAuth: true, requiredRoles: ["Super Admin", "Organization Admin"] },
  { id: "mobile-release", section: "organization-admin", path: "admin/mobile-release", label: "Mobile Release", module: "mobile-release", description: "Mobile store launch console for listing packs, reviewer accounts, screenshots, release health, and staged rollout controls", access: "role-protected", requiresAuth: true, requiredRoles: ["Super Admin", "Organization Admin"] },
