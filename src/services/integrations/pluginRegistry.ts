...
const basePlugins: Omit<ProductivityPlugin, "configured">[] = [
  ...
  { id: "slack", name: "Slack", category: "messaging", useCases: ["ops alerts", "task notifications"], requiredScopes: ["chat:write", "channels:read"], pilotEnabled: false, webhookSupport: true, requiredRoles: ["Organization Admin"], auditEvents: ["slack.notification.sent"] },
  ...
  { id: "notion", name: "Notion", category: "document", useCases: ["knowledge import", "meeting notes"], requiredScopes: ["read_content"], pilotEnabled: false, webhookSupport: false, requiredRoles: ["Manager"], auditEvents: ["notion.page.imported"] },
  ...
  { id: "linear", name: "Linear", category: "project-management", useCases: ["engineering issue sync"], requiredScopes: ["read", "write"], pilotEnabled: false, webhookSupport: true, requiredRoles: ["Manager"], auditEvents: ["linear.issue.synced"] },
  { id: "github", name: "GitHub", category: "project-management", useCases: ["release tracking", "issue sync"], requiredScopes: ["repo:read", "issues:write"], pilotEnabled: false, webhookSupport: true, requiredRoles: ["Organization Admin"], auditEvents: ["github.issue.synced"] },
  { id: "hubspot", name: "HubSpot", category: "crm", useCases: ["stakeholder CRM", "deal notes"], requiredScopes: ["crm.objects.contacts.read"], pilotEnabled: false, webhookSupport: true, requiredRoles: ["Executive"], auditEvents: ["hubspot.contact.synced"] },
  ...
  { id: "airtable", name: "Airtable", category: "database", useCases: ["pilot data import"], requiredScopes: ["data.records:read"], pilotEnabled: false, webhookSupport: true, requiredRoles: ["Manager"], auditEvents: ["airtable.records.imported"] },
  { id: "google_sheets", name: "Google Sheets", category: "database", useCases: ["district sheet import", "budget tracker"], requiredScopes: ["spreadsheets.readonly"], pilotEnabled: false, webhookSupport: false, requiredRoles: ["Manager"], auditEvents: ["sheets.range.imported"] },
