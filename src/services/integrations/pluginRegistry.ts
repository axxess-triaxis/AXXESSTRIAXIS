...
const basePlugins: Omit<ProductivityPlugin, "configured">[] = [
  ...
  { id: "google_sheets", name: "Google Sheets", category: "database", useCases: ["district sheet import", "budget tracker"], requiredScopes: ["spreadsheets.readonly"], pilotEnabled: true, webhookSupport: false, requiredRoles: ["Manager"], auditEvents: ["sheets.range.imported"] },
  { id: "google_docs", name: "Google Docs", category: "document", useCases: ["policy document import", "briefing notes"], requiredScopes: ["documents.readonly"], pilotEnabled: true, webhookSupport: false, requiredRoles: ["Manager"], auditEvents: ["docs.document.imported"] },
  { id: "google_slides", name: "Google Slides", category: "document", useCases: ["stakeholder deck import", "board presentation sync"], requiredScopes: ["presentations.readonly"], pilotEnabled: true, webhookSupport: false, requiredRoles: ["Manager"], auditEvents: ["slides.deck.imported"] },
