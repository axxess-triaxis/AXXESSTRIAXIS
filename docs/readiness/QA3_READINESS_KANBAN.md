...
| A-06 Verify Tenant 0 organization provisioning | 1 | HITL | 95% | **First successful live tenant provisioning in this program's history** -- Triaxis Ventures Pvt Ltd provisioned, real workspace loaded, 2026-07-24. Second real tenant, "Tenant 0.5" (NEPDSIC), provisioned 2026-07-25 -- HITL-reported, onboarding in progress at time of writing, no separate screenshot yet |
