...
Governed by: `CLAUDE.md` (Decision Ledger -- Standing Rule). Created 2026-08-17. `CLAUDE.md` already
...
## Known standing architecture/scope decisions (seeded 2026-08-17)
