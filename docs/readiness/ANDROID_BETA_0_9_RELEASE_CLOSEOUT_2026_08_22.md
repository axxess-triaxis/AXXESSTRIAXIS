...
- Internal testing: version 2 bundle attached, release notes and the 7-address tester list (`sudipta1213@gmail.com`, `ritashreebsc@gmail.com`, `triaxisgrp@gmail.com`, `ekora.hive@gmail.com`, `imprintsprod@gmail.com`, `hello@elevatewealthx.com`, `pollobmahanta@gmail.com`) added, release published. Founder-reported from the live console: **released, 5 of 7 users showing as reached** — not independently screenshotted by me at that exact moment, so tagged founder-stated rather than directly verified, though it is a direct read of the Play Console UI rather than a recollection.
