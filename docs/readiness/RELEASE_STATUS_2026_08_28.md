...
**Owner/action:** founder to visually confirm the sign-out button on a real session; consider whether Organization/Profile need a similar "did we miss an obvious control" pass given this was found live, not in review.
