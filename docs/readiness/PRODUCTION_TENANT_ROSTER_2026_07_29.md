...
|---|---|---|---|---|
| `b118816e-b899-4fc4-8589-3cf0456b0057` | Ehive | [PILOT_CONTACT_EMAIL_MASKED_EHIVE] | -- | Email |
| `9adcaff6-74bb-48c7-8ade-43862ecac30a` | Imprints | [PILOT_CONTACT_EMAIL_MASKED_IMPRINTS] | -- | Email |
| `1f8851c3-f027-4b9e-9a5f-83446a849c4d` | Triaxis Ventures | [FOUNDER_EMAIL_MASKED] | -- | Email |
| `9c5356d2-8d83-4f94-95f8-e56a4e25459c` | NEPDSIC | [FOUNDER_SECONDARY_EMAIL_MASKED] | -- | Email |
| `a4ce5ec0-f497-49f4-8341-e8859789f875` | Triaxis Ventures | [FEEDBACK_ROUTING_EMAIL_MASKED] | -- | Email |
...
- **Triaxis Ventures (`[FOUNDER_EMAIL_MASKED]`)** = Tenant 0, the founder's own primary account,
  already established earlier in this program.
- **NEPDSIC (`[FOUNDER_SECONDARY_EMAIL_MASKED]`)** = Tenant 0.5, the second real tenant used for TP-1/
  TP-2/TP-3's tenant-isolation testing this session.

## Second "Triaxis Ventures" Account -- Resolved

**Two accounts are both named "Triaxis Ventures"** -- `[FOUNDER_EMAIL_MASKED]` (established) and
`[FEEDBACK_ROUTING_EMAIL_MASKED]` (new, UID `a4ce5ec0-...`). `[FEEDBACK_ROUTING_EMAIL_MASKED]` also appeared earlier this
