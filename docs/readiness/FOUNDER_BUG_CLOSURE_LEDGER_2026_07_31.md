...
45. **[A-65] "Send Feedback" never reaches `[FEEDBACK_ROUTING_EMAIL_MASKED]`** — two root causes fixed in code; blocked purely on a production secret. **Founder: Unresolved — part of the SMTP callout above; SMTP setup can resolve this alongside ~7-8 standing issues.**
