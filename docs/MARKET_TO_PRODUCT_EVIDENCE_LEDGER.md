...
| Beta feedback | 35+ | 30 raw / 28 deduplicated | `Enterprise beta feedback - Batch 1 (30 responses)/Enterprise_Beta_Feedback_Batch_1.md` | Real survey batch exists and is analyzed in depth (NPS, themes, pilot-intent breakdown), but the verified count (28-30) falls short of the stated "35+" -- record as Partial, not Verified, until a Batch 2 or additional source closes the gap. The batch's own "1,200+ actionable feedback points" (1,236 raw / 1,112 deduplicated) is an instrument-depth metric, not a headcount, and traces to this same 28-30 batch -- not to the separate, earlier 23-respondent `BETA_0.5_0.7_FEEDBACK_ANALYSIS_2026_07_23.md`, contrary to a 2026-07-25 founder recollection. Full reconciliation, including "1,600+" (no source artifact found) and word-count checks on the "7,000+ word analysis" (verified: 7,784 words) and "35-40k words of founder walkthrough" (no raw-transcript artifact found) claims: `docs/readiness/BETA_FEEDBACK_EVIDENCE_RECONCILIATION_2026_07_25.md` |
